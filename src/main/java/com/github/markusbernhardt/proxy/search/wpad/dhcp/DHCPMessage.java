...
public class DHCPMessage {
	...
	// -----------------------------------------------------------
	/**
	 * Initializes datamembers in the constructors every empty DHCPMessage
	 * object will by default contain these params. Initializes options array
	 * from linked list form.
	 */
	 ...
	 * 
	 * @return A byte array with information from DHCPMessage object, ready to
	 *         send.
	 */
